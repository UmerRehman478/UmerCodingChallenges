...
public class FileExercisesTest {
	...
	@Test
	public void test_counting_zero() throws FileNotFoundException, IOException {
	...
	@Test
	public void test_counting_onlyWordIsThe() throws FileNotFoundException, IOException {
		String content = "the";
		createFile("example.txt", content);
		int actual = 0;
		actual = FileExercises.counting("THE");
	...
	@Test
	public void test_counting_upperAndLowerCaseThe() throws FileNotFoundException, IOException {
	...
	@Test
	public void test_counting_sameWordRepeated() throws FileNotFoundException, IOException {
